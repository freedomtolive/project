			...
			<div>
				<div className="jumbotron text-center">
		          <div className="container">
		            <h1>React问答</h1>
		            < AddQuestionBtn onTriggerForm = {this.onTriggerForm} />
		          </div>
			      </div>
			      <div className="main container">
			        < AddQuestionForm onNewQuestion = {this.onNewQuestion}  formDisplayed={this.state.formDisplayed} onTriggerForm = {this.onTriggerForm} />
			        < AddQuestion questions = {this.state.questions} />
